...
<div class="flex items-center justify-between mb-6">
    <div>
        ...
        <p class="text-sm text-gray-500 mt-0.5">Manage registered personnel and their access privileges</p>
    </div>
...
<div class="bg-white shadow-sm rounded-xl border border-gray-200">
    <div class="p-6">
        <table id="employees-dt" class="w-full" style="width:100%">
            <thead>
                <tr>
                    <th>Name</th>
                    <th>Badge #</th>
...
{{-- MDB Import Modal --}}
@include('credentials::employees._mdb_import_modal')
@endsection
...
$(function () {
    ...
    var table = $('#employees-dt').DataTable({
        processing: true,
        serverSide: true,
        ajax: {
        ...
        columns: [
            { data: 'name' },
            { data: 'badge_number',    searchable: true,  orderable: true  },
            { data: 'card_no',         searchable: true,  orderable: true  },
            { data: 'org_name',        searchable: false, orderable: false },
            { data: 'privilege_label', searchable: false, orderable: false },
