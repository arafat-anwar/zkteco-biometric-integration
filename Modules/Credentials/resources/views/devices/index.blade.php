...
<div class="flex items-center justify-between mb-6">
    <div>
        ...
        <p class="text-sm text-gray-500 mt-0.5">Manage biometric terminals and sync status</p>
    </div>
...
<div class="bg-white shadow-sm rounded-xl border border-gray-200">
    <div class="p-6">
        <table id="devices-dt" class="w-full" style="width:100%">
            <thead>
                <tr>
                    <th>Name</th>
                    <th>Organization</th>
...
{{-- MDB Import Modal --}}
@include('credentials::devices._mdb_import_modal')
@endsection
...
$(function () {
    ...
    var table = $('#devices-dt').DataTable({
        processing: true,
        serverSide: true,
        ajax: {
