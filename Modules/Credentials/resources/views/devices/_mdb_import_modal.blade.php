<div id="mdb-import-modal" class="hidden fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
    <div class="bg-white rounded-lg shadow-xl w-full max-w-md">
        <div class="flex items-center justify-between p-4 border-b">
            <h3 class="text-lg font-semibold text-gray-800">Import Devices from MDB</h3>
        ...
        <form method="POST" action="{{ route('mdb.import.devices') }}" enctype="multipart/form-data">
            @csrf
            <div class="p-4 space-y-4">
                ...
                <div>
                    ...
                    <p class="text-xs text-gray-400 mt-1">Reads <strong>Machines</strong> table from ZKTeco MDB database. Existing devices (matched by serial number) will be updated.</p>
                </div>
            </div>
